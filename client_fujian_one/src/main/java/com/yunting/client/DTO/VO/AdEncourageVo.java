...
@AllArgsConstructor
@NoArgsConstructor
public class AdEncourageVo {
    @ApiModelProperty(value = "本次广告时长")
    private Integer advTimeDate;
    ...
    @ApiModelProperty(value = "双端无回调时间", dataType = "LocalDateTime")
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    private LocalDateTime doubleCallbackTime;
