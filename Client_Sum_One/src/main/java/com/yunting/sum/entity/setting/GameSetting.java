...
public class GameSetting {
    ...
    @ApiModelProperty(value = "应用后台最大闲置时长", dataType = "int")
    private Integer resetMaxTime;
    ...
    @ApiModelProperty(value = "是否启用功能 ：周末是否限制时间段", dataType = "String")
    private String isAnchorWeekend;
